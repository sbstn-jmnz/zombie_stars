...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { health: @zombie.health, kills: @zombie.kills, name: @zombie.name, photo: @zombie.photo } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { health: @zombie.health, kills: @zombie.kills, name: @zombie.name, photo: @zombie.photo } }
